...
def extract_listings(page_soup):
    ...
    for a in page_soup.find_all('a', href=True):
        if "/partner/jobListing.htm?" in a['href']:
            ...
            # <<<<<<< change glassdoor.es/uk/fr/etc por país >>>>>>
            listings_list.append("www.glassdoor.ca" + a['href'])
...
if __name__ == "__main__":
    ...
    url = "https://www.glassdoor.es/Job/spain-data-scientist-jobs-SRCH_IL.0,5_IN219_KO6,20.htm"
    start_time = time()
